...
def argparser():
    ...
    arg_parse.add_argument("--features_test", help="Test features file.", metavar="FILE", default=None)
    ...
    arg_parse.add_argument("--clip_value", help="Set scores lower than this to 0.", metavar="FLOAT", default=0.01, type=float)
